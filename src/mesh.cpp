...
std::vector<VertexPositionNormal> mini::Mesh::SkyboxVerts (float side, float height) {
	return {
		{{0.5f * side,0.5f * height,-0.5f * side},{0.0f,1.0f,0.0f}},
		{{-0.5f * side,0.5f * height,-0.5f * side},{0.0f,1.0f,0.0f}},
		{{-0.5f * side,0.5f * height,0.5f * side},{0.0f,1.0f,0.0f}},
		{{0.5f * side,0.5f * height,0.5f * side},{0.0f,1.0f,0.0f}},
		{{0.5f * side,-0.5f * height,0.5f * side},{0.0f,0.0f,1.0f}},
		{{0.5f * side,0.5f * height,0.5f * side},{0.0f,0.0f,1.0f}},
		{{-0.5f * side,0.5f * height,0.5f * side},{0.0f,0.0f,1.0f}},
		{{-0.5f * side,-0.5f * height,0.5f * side},{0.0f,0.0f,1.0f}},
		{{-0.5f * side,-0.5f * height,0.5f * side},{-1.0f,0.0f,0.0f}},
		{{-0.5f * side,0.5f * height,0.5f * side},{-1.0f,0.0f,0.0f}},
		{{-0.5f * side,0.5f * height,-0.5f * side},{-1.0f,0.0f,0.0f}},
		{{-0.5f * side,-0.5f * height,-0.5f * side},{-1.0f,0.0f,0.0f}},
		{{-0.5f * side,-0.5f * height,-0.5f * side},{0.0f,-1.0f,0.0f}},
...
std::vector<unsigned short> mini::Mesh::SkyboxIdx () {
	return { 2, 1, 0, 3, 2, 0, 6, 5, 4, 7, 6, 4, 10, 9, 8, 11, 10, 8, 14, 13, 12, 15, 14, 12, 18, 17, 16, 19, 18, 16, 22, 21, 20, 23, 22, 20 };
}
